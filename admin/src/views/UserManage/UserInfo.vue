    ...
    <div class="info-box">
      ...
      <el-form :model="userData" class="form-box">
        <el-form-item label="邮箱">
          <el-input v-model="getUser.email" readonly></el-input>
        </el-form-item>
        <el-form-item label="密码">
          <el-input type="password" v-model="userData.password"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button @click="onSubmit" :disabled="!userData.password" type="primary" :loading="loading">
            修改密码
          </el-button>
        </el-form-item>
      </el-form>
...
export default class UserInfo extends Vue {
  ...
  @Provide() userData:{email:string;password:string;} = {
    email: '',
    password: ''
  }
